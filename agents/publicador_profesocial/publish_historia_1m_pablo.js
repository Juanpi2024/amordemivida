...
const COMMON_CONFIG = {
    ...
    basePath: 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\ENSEÑANZA MEDIA\\PRIMERO MEDIO\\HISTORIA\\HIST. CON DUA',
};

const TEMP_DIR = path.join(__dirname, 'temp_pablo', 'historia_1m');
...
function generarMetadatos(item) {
    const mainSubject = 'Historia, Geografía y Ciencias Sociales';
    return {
        ...
        description: `
            ...
            Recurso pedagógico completo y detallado para la asignatura de <strong>Historia, Geografía y Ciencias Sociales</strong>.<br><br>
