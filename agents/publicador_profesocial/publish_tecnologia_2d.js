...
// Configuración Base - TECNOLOGÍA 2°
const COMMON_CONFIG = {
    precio: '6',
    minAge: '6',
    maxAge: '8',
    ...
    basePath: 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\PRIMER CICLO\\segundo basico\\ASIGNATURAS\\tecnologica'
};
...
function generarMetadatos(item) {
    ...
    const descripcion = `
        ...
        <ul>
            ...
            <li>Objetivos de Aprendizaje (OA) de Tecnología.</li>
            <li>Indicadores de evaluación claros.</li>
            <li>Uso de software de presentación y dibujo.</li>
            <li>Creación de objetos tecnológicos simples.</li>
        </ul><br>
...
(async () => {
    console.log(`🏰 LENIN TECHNOLOGY 2D: Iniciando proceso de Limpieza y Publicación...`);
    ...
    try {
        ...
        for (const item of cleanFiles) {
            ...
            if (metaResult.success || (metaResult.outputPath && fs.existsSync(metaResult.outputPath))) {
                ...
                console.error(`   🛑 ERROR: No se pudo limpiar el archivo (posible DOC binario o protegido).`);
                console.error(`   ⚠️ SE OMITE LA PUBLICACIÓN DE ESTE ARCHIVO POR SEGURIDAD.`);
            ...
            try {
                ...
                await page.screenshot({ path: `tecnologia_error_${item.mes}.png` });
            }

            await page.waitForTimeout(3000);
        }

        console.log('\n🏁 FIN DEL PROCESO DE TECNOLOGÍA.');
