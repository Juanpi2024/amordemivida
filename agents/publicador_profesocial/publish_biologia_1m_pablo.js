...
const COMMON_CONFIG = {
    ...
    basePath: 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\ENSEÑANZA MEDIA\\PRIMERO MEDIO\\CS NATURALES\\BIOLOGIA',
};

const TEMP_DIR = path.join(__dirname, 'temp_pablo', 'biologia_1m');
...
function generarMetadatos(item) {
    ...
    return {
        ...
        description: `
            ...
            Recurso pedagógico completo y detallado para la asignatura de <strong>Ciencias Naturales - Biología</strong>.<br><br>
