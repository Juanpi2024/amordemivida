...
// Configuración de la ruta de Historia
const rootDir = 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\ENSEÑANZA MEDIA\\PRIMERO MEDIO\\HISTORIA\\HIST. CON DUA';
    ...
    for (const entry of entries) {
        ...
        try {
            if (entry.isDirectory()) {
                ...
                } else if (!fullPath.includes('LIMPIO')) {
                    // console.log(`⏩ Omitiendo (no cumple criterios): ${entry.name}`);
                }
            }
        } catch (fileErr) {
...
(async () => {
    try {
        console.log(`\n🚀 COMENZANDO LIMPIEZA DE HISTORIA: ${rootDir}`);
        console.log(`================================================================`);
