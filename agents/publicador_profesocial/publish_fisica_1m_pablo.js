...
const COMMON_CONFIG = {
    ...
    basePath: 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\ENSEÑANZA MEDIA\\PRIMERO MEDIO\\CS NATURALES\\FISICA',
};

const TEMP_DIR = path.join(__dirname, 'temp_pablo', 'fisica_1m');
...
function generarMetadatos(item) {
    ...
    return {
        ...
        description: `
            ...
            Recurso pedagógico completo y detallado para la asignatura de <strong>Ciencias Naturales - Física</strong>.<br><br>
