...
const rootDir = 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\ENSEÑANZA MEDIA\\PRIMERO MEDIO\\MATEMATICA\\MAT. CON DUA';
...
async function processFile(filePath) {
    ...
    try {
        if (ext === '.docx') {
            const cleanPath = path.join(tempDir, path.basename(filePath, '.docx') + '_LIMPIO.docx');
...
(async () => {
    console.log(`Comenzando búsqueda en: ${rootDir}`);
