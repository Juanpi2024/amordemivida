...
const COMMON_CONFIG = {
    ...
    basePath: 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\ENSEÑANZA MEDIA\\PRIMERO MEDIO\\INGLES',
};

const TEMP_DIR = path.join(__dirname, 'temp_pablo', 'ingles_1m');
...
function generarMetadatos(item) {
    const mainSubject = 'Idioma Extranjero Inglés';
    return {
        ...
        description: `
            ...
            Recurso pedagógico completo y detallado para la asignatura de <strong>Idioma Extranjero Inglés</strong>.<br><br>
