...
const COMMON_CONFIG = {
    ...
    basePath: 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\PRIMER CICLO\\segundo basico\\ASIGNATURAS\\IINGLES'
};
...
function generarMetadatos(item) {
    ...
    const descripcion = `
        ...
        <ul>
            ...
            <li>Objetivos de Aprendizaje (OA) cubiertos en el mes para Inglés.</li>
            <li>Indicadores de evaluación claros.</li>
            <li>Actividades para el desarrollo de las 4 habilidades: Listening, Speaking, Reading, Writing.</li>
            <li>Vocabulario temático y estructuras gramaticales.</li>
        </ul><br>
...
(async () => {
    console.log(`🏰 LENIN ENGLISH 2D: Iniciando proceso de Limpieza y Publicación...`);
    ...
    try {
        ...
        for (const item of cleanFiles) {
            ...
            try {
                ...
                await page.screenshot({ path: `ingles_error_${item.mes}.png` });
            }

            await page.waitForTimeout(3000);
        }

        console.log('\n🏁 FIN DEL PROCESO DE INGLÉS.');
