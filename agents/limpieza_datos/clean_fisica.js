...
const rootDir = 'D:\\Users\\Pablo\\Desktop\\ESCRITORIO TRABAJO 2023\\mi aula editado\\ENSEÑANZA MEDIA\\PRIMERO MEDIO\\CS NATURALES\\FISICA';
...
(async () => {
    console.log(`Comenzando búsqueda en Física: ${rootDir}`);
